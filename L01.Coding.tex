...
\title[L01]{Software Engineering -- Coding\newline\newline
 L01: Introduzione to ChatGPT} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\begin{center}
    \include{P2023.AIBCCSS.IlConcettoDiSoftware/SoftwareAttoCreativo.FunzioneDiCosto}
\end{center}
